...
void loop()
{
  sparki_RGB(100,0,0); // Make the LED maximum Red
  delay(500); // wait 0.5 seconds (500 milliseconds)

  sparki_RGB(0,100,0); // Make the LED maximum Green
  delay(500);

  sparki_RGB(0,0,100); // Make the LED maximum Blue
  delay(500);

  sparki_RGB(RGB_WHITE); // Make the LED white (all colors)
  delay(500);

  sparki_RGB(RGB_OFF); // Make the LED white (all colors)
  delay(500);
}
